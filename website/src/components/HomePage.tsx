  ...
  return (
    <div id="home" className="hero-container">
      ...
      <img
        src={WindCharacter}
        alt="Wind Character"
        className="wind-character fade-in"
      ...
      <div className="hero-content mt-10">
        ...
        <h1 className="hero-heading fade-in" style={{ animationDelay: "0.3s" }}>
          Hi, I'm William.
        </h1>

        {/* Location with icon */}
        <p className="hero-location fade-in" style={{ animationDelay: "0.5s" }}>
          <MdLocationOn /> Seattle, WA
        </p>

        {/* Subheading with fade-in animation */}
        <p
          className="hero-subheading fade-in"
          style={{ animationDelay: ".7s" }}
        >
          I'm currently a student at the University of Washington, where I
          specialize in Data Science and Software Development 🚀
        </p>

        {/* Buttons for CV download and contact */}
        <div className="button-group fade-in" style={{ animationDelay: ".7s" }}>
          <a href={cvLink} download className="button-black">
            Download CV
          </a>
          <button
            onClick={() =>
        ...
        <div
          className="social-buttons fade-in"
          style={{ animationDelay: ".7s" }}
        >
          <a
            href="https://www.linkedin.com/in/william-uyeta-/"
            target="_blank"
          ...
          <a
            href="https://github.com/williamuy"
            target="_blank"
            rel="noopener noreferrer"
            className="social-button"
          >
        ...
        <div
          className="typewriter-container fade-in mt-4"
          style={{ animationDelay: ".7s" }}
        >
